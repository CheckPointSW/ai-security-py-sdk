...
class BrowseSecurity(_BrowseApiMixin):
    ...
    def __init__(self):
        ...
        if print_message:
            print('Check Point Browse Security SDK - https://github.com/CheckPointSW/ai-security-py-sdk')
    ...
    def info() -> str:
        ...
        try:
            from chkp_ai_security_sdk.generated_browse.sdk_build import sdk_build_info
            return str(sdk_build_info())
        except Exception:
            return 'SDK info not available (run sdk_generator/generate_sdk.py first)'

    def _get_api_client(self):
        from chkp_ai_security_sdk.generated_browse.api_client import ApiClient
